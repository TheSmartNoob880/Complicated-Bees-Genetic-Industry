...
public class genomeExtractorCategory implements IRecipeCategory<Species> {
    ...
    public static final ResourceLocation ID = new ResourceLocation(GendustratedBees.MODID, "jei/genome_extractor");
    public static final RecipeType<Species> TYPE;
    private static final Component TITLE;
    private final IDrawable ICON;
    private final IDrawable BACKGROUND = GendustratedBeesJEI.createDrawable(new ResourceLocation("gendustrated_bees", "textures/gui/jei/genome_extractor_jei.png"), 0, 0, 176, 112, 176, 112);
    ...
    static {
        ...
        TITLE = Component.translatable("gui.gendustrated_bees.jei.genome_extractor");
    }
}
