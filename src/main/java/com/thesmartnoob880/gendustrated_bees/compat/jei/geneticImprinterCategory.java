...
public class geneticImprinterCategory implements IRecipeCategory<Species> {
    ...
    private static final ResourceLocation ID = new ResourceLocation(GendustratedBees.MODID, "jei/genetic_imprinter");
    public static final RecipeType<Species> TYPE;
    private static final Component TITLE;
    private final IDrawable ICON;
    private final IDrawable BACKGROUND = GendustratedBeesJEI.createDrawable(new ResourceLocation("gendustrated_bees", "textures/gui/jei/genetic_imprinter_jei.png"), 0, 0, 143, 64, 143, 64);
    ...
    static {
        ...
        TITLE = Component.translatable("gui.gendustrated_bees.jei.genetic_imprinter");
    }
}
